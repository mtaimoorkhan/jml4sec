...
//    }
    ...
    // exceptional_behavior | compromised_behavior ] [ clause ]*
    public JmlSpecificationCase parseSpecificationCase(JCModifiers mods,
        ...
        int pos = pos();
        if (ext == behaviorClause || ext == compromisedBehaviorClause || ext == normalBehaviorClause || ext == exceptionalBehaviorClause
