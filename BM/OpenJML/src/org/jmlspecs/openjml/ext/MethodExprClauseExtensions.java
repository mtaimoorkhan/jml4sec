...
public class MethodExprClauseExtensions extends JmlExtension {
    ...
    public static final String SQLINJECTIONID ="SQLINJECTION";
    ...
    public static final IJmlClauseKind alarmsClause = new MethodClauseExprType(alarmsID);
    
    public static final IJmlClauseKind SQLINJECTIONClause = new MethodClauseExprType(SQLINJECTIONID);
