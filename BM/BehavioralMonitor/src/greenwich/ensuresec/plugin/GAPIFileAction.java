package greenwich.ensuresec.plugin;
...
import greenwich.ensuresec.vistor.WorkspaceUtilities;
	...
	System.out.println("Run Action: " + action.getId());
	   ...
	   int testType = -1;
		...
		protected IStatus run(IProgressMonitor monitor) {
			...
			UAnalysis.analyzeJMLFromPlugin(cus,ftestType,monitor);
