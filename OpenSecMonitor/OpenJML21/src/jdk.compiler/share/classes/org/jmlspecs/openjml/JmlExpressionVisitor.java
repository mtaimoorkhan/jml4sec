...
//ADD-OPENJMLSEC(Wyatt)
    public R visitJmlMethodClauseAlarms(JmlMethodClauseAlarms that, P p)                { return shouldNotBeCalled(that); }
    public R visitJmlMethodClauseAction(JmlMethodClauseAction that, P p)                { return shouldNotBeCalled(that); }
//ADD-END*/
}
