...
import org.jmlspecs.openjml.ext.MethodSimpleClauseExtensions.MethodKeywordClauseType;
...
public class MethodSimpleClauseExtensions extends JmlExtension {
    ...
    public static final String actionBehaviorID = "action_behavior";
    
    public static final IJmlClauseKind compromisedBehaviorClause = new MethodKeywordClauseType(compromisedBehaviorID);
    public static final IJmlClauseKind actionBehaviorClause = new MethodKeywordClauseType(actionBehaviorID);
    //ADD-END*/
    ...
    static {
        ...
        synonym("action_behaviour",actionBehaviorClause);
        //ADD-END*/
