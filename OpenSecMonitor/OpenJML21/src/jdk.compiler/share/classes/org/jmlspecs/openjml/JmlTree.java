...
//        JmlStoreRefKeyword JmlStoreRefKeyword(IJmlClauseKind t);
        ...
        JmlMethodClauseAlarms JmlMethodClauseAlarms(String keyword, JCTree.JCExpression condition, IJmlClauseKind kind, JCTree.JCExpression e);
        //JmlMethodClauseAction JmlMethodClauseAction(String keyword, JCTree.JCExpression condition, IJmlClauseKind kind, JCTree.JCExpression e);
        JmlMethodClauseAction JmlMethodClauseAction(String keyword, JCTree.JCExpression condition, IJmlClauseKind kind, JCTree.JCStatement s);
        //ADD-END*/
    }
...
//        @Override
//        public JmlMethodInvocation JmlMethodInvocation(IJmlClauseKind kind, List<JCExpression> args) {
...
//        public JmlMethodInvocation JmlMethodInvocation(IJmlClauseKind token, JCExpression arg, JCExpression arg2) {
...
//        }
        ...
        //ADD-OPENJMLSEC(Wyatt)
        @Override
        public JmlMethodClauseAlarms JmlMethodClauseAlarms(String keyword, JCTree.JCExpression attackType, IJmlClauseKind t, JCTree.JCExpression e) {
            return new JmlMethodClauseAlarms(pos,keyword,attackType, t,e);
        }
        
        //@Override
        //public JmlMethodClauseAction JmlMethodClauseAction(String keyword, JCTree.JCExpression actionType, IJmlClauseKind t, JCTree.JCExpression e) {
        //    return new JmlMethodClauseAction(pos,keyword,actionType, t,e);
        //}
        
        @Override
        public JmlMethodClauseAction JmlMethodClauseAction(String keyword, JCTree.JCExpression actionType, IJmlClauseKind t, JCTree.JCStatement s) {
            return new JmlMethodClauseAction(pos,keyword,actionType, t, s);
        }
        //ADD-END*/
...
//        }
    ...
    public static class JmlMethodClauseAlarms extends JmlMethodClause {
        public JCTree.JCExpression attackType;
        public JCTree.JCExpression expression;

        protected JmlMethodClauseAlarms(int pos, String keyword, JCTree.JCExpression attackType, IJmlClauseKind clauseType, JCTree.JCExpression expression) {
            super(pos, keyword, clauseType);
            this.expression = expression;
    ...
    // This class represents a action clause in a method specification.
    public static class JmlMethodClauseAction extends JmlMethodClause {
        public JCTree.JCExpression actionType;
        //public JCTree.JCExpression expression;
        public JCTree.JCStatement statement;

        /*protected JmlMethodClauseAction(int pos, String keyword, JCTree.JCExpression actionType, IJmlClauseKind clauseType, JCTree.JCExpression expression) {
            super(pos, keyword, clauseType);
            this.expression = expression;
            this.actionType = actionType;
        }*/
        protected JmlMethodClauseAction(int pos, String keyword, JCTree.JCExpression actionType, IJmlClauseKind clauseType, JCTree.JCStatement statement) {
	        super(pos, keyword, clauseType);
	        this.statement = statement;
	        this.actionType = actionType;
        }
        ...
        public void accept(Visitor v) {
            if (v instanceof IJmlVisitor) {
                ((IJmlVisitor)v).visitJmlMethodClauseAction(this); 
            } else {
                super.accept(v);
            }
        }
        ...
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
            if (v instanceof JmlTreeVisitor) {
                return ((JmlTreeVisitor<R,D>)v).visitJmlMethodClauseAction(this, d);
            } else {
                System.out.println("A JmlMethodClauseAction expects an JmlTreeVisitor, not a " + v.getClass());
                return super.accept(v,d);
            }
        }
    }
