...
//            Log.instance(context).error("jml.internal","Unexpected call of JmlFlow.visitJmlMethodClauseExpr");
        ...
        @Override
        public void visitJmlMethodClauseAlarms(JmlMethodClauseAlarms that) {
            Log.instance(context).error("jml.internal","Unexpected call of JmlFlow.visitJmlMethodClauseAlarms");
        }

        @Override
        public void visitJmlMethodClauseAction(JmlMethodClauseAction that) {
            Log.instance(context).error("jml.internal","Unexpected call of JmlFlow.visitJmlMethodClauseAction");
        }
        //ADD-END
