...
also
  ...
  public void setValue(int value_arg) {
    if (!uk.gre.ac.openjmlsec.gen.EscVerify.verify("uk.gre.ac.openjmlsec.testclasses.Marshal", "", "int", "setValue", new java.lang.Object[]{value_arg})) {
      if (value_arg < 0) value_arg = 0;
      if (value_arg < 0) value_arg = 10000;
    }
    value = value_arg;
  }
