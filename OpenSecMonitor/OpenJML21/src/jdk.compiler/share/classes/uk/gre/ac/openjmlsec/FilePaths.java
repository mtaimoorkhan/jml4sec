...
public class FilePaths {
	...
	/*/
    public static final String FILE_SOURCE_PATH = PROJECT_PATH + "../../OPENJMLSEC_TESTS/src/testclasses/";
    public static final String FILE_OUTPUT_PATH = PROJECT_PATH + "../../OPENJMLSEC_TESTS/src/generatedClasses/";
    public static final String SOURCE_FOLDER = PROJECT_PATH + "../../OPENJMLSEC_TESTS/src/";
    //*/
