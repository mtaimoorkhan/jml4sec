...
also
  ...
  /*@ pure*/ private static boolean SomeSqlCall(int value, String an_agrument) {
    if (!uk.gre.ac.openjmlsec.gen.EscVerify.verify("testclasses.SqlInjection", "", "int,String", "SomeSqlCall", new java.lang.Object[]{value, an_agrument})) {
      boolean EscVerify_recovered = false;
      if (Attacks.HasSQLInjection(an_agrument)) {
        Attacks.Log("An attempted SQL injection detected: " + an_agrument);
